 ...
 * 2. Или просто вставить в любую страницу
 * 3. Поменять API_URL на свой бэкенд (строка 18)
 */
...
(function() {
    ...
    // =============================================
    // КОНФИГУРАЦИЯ — поменяй API_URL на свой!
    // =============================================
    const CONFIG = {
    ...
    function injectStyles() {
        ...
        css.textContent = `
            ...
            .mc-field-icon.top { top: 14px; transform: none; }
            ...
            .mc-btn-load { display: flex; align-items: center; justify-content: center; gap: 6px; }
            .mc-spinner {
